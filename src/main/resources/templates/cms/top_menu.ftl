<div id="header">
	...
	<p><a href="/cms/logout">退出管理</a> <a href="/cms/self/welcome">后台首页</a> <a href="/" target="_blank">网站首页</a> <span>您好 <label class="bold">${Session["KEY_CMS_USER"].nickName?default("")}</label>，当前身份 <label class="bold">超级管理员</label></span></p>
</div>